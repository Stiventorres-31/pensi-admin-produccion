      ...
      if (foto != null) {
        ...
        try {
          const res = await axios.post(
            `${API_URL}/api/noticias-update-imagen/` + id,
            f,
            {
              headers: {
                "Content-Type": "multipart/form-data",
            ...
            <>
              <div className="inline-flex justify-center space-x-4 w-full">
                <button
                  ...
                  onClick={() => openModal(2, id, t, d, e, l)}
                >
                  <i className="fa-solid fa-file-pen"></i>
                </button>
                <button
                  className="block text-white hover:bg-acent focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#be0a0a]"
                  onClick={() => deleteNovedades(id, t)}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
            ...
            <div className="relative col-span-2 z-0 w-full mb-5 group">
              <input
                ...
                name="titulo"
                id="titulo"
                className="peer block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-acent"
                placeholder=" "
                value={title}
              ...
              <label
                htmlFor="titulo"
                className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 peer-focus:text-acent peer-focus:dark:text-acent"
              >
                Título
              </label>
            </div>
            ...
            {/* Etiqueta */}
            <div className="relative col-span-2 md:col-span-1 z-0 w-full mb-5 group">
              <input
                type="text"
                name="etiqueta"
                id="etiqueta"
            ...
            <div className="relative col-span-2 md:col-span-1 z-0 w-full mb-5 group">
              <input
                ...
                placeholder=" "
                value={link_n}
                onChange={(e) => setLink_n(e.target.value)}
              />
              <label
                htmlFor="link"
                className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 peer-focus:text-acent peer-focus:dark:text-acent"
